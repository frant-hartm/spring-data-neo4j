...
import org.springframework.data.neo4j.integration.conversion.tests.SecondTest.MyOtherConfig;
...
@ContextConfiguration(classes = {GalaxyContext.class, MyOtherConfig.class})
@Transactional
@Rollback
